...
export type AdditonTestCaseData = {
  additions: Pair[];
  result: Pair;
};

export type MagnitudeTestCaseData = {
  pair: Pair[];
  result: number;
};

export const additionTestData: AdditonTestCaseData[] = [
  {
    additions: [
      [1, 1],
      [2, 2],
...
export const magnitudeTestData: MagnitudeTestCaseData[] = [
  {
    pair: [
      [1, 2],
      [[3, 4], 5],
...
export const data = `[[6,[[9,4],[5,5]]],[[[0,7],[7,8]],[7,0]]]
